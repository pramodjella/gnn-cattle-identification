...
under occlusion; we additionally verify the two most severe cases with keypoints recomputed
from the corrupted images (\Cref{sec:corrupt}). (v) The two GNN explainers we compare show
